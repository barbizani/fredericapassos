...
// Add Tailwind CSS and font loading
function frederica_passos_load_tailwind() {
    ?>
    <!-- Tailwind CSS CDN -->
...
add_action('wp_head', 'frederica_passos_load_tailwind', 1);
...
// Adicionar fontes customizadas ao Elementor
...
// Adicionar CSS para fontes customizadas do Elementor
add_action('elementor/frontend/after_enqueue_styles', function() {
    ...
    .elementor-widget-heading .elementor-heading-title[style*="JH Caudemars"],
    .elementor-heading-title {
        font-family: 'JH Caudemars', serif !important;
    }
