...
export const metadata: Metadata = {
  ...
  description: 'Atendimento prioritário de psiquiatria para o Algarve. Agende sua teleconsulta hoje mesmo e recupere seu equilíbrio.',
  keywords: ['psiquiatria algarve', 'teleconsulta algarve', 'consulta online algarve', 'insónia', 'tdah adulto', 'saúde sexual'],
  openGraph: {
