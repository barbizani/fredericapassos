            ...
            onSubmit={async (e) => {
              ...
              if (Object.keys(errors).length === 0) {
                ...
                try {
                  ...
                  // Garante que o estado "Aguarde..." seja visível por pelo menos 800ms
            ...
            <AnimatePresence>
              {showSuccessMessage && (
                  <motion.div
                    ...
                    exit={{ opacity: 0, y: -10 }}
                    className="mt-4 p-4 bg-white/20 backdrop-blur-md border border-white/40 rounded-lg text-white text-center font-neue-montreal flex flex-col items-center gap-2 shadow-xl"
                  >
                    ...
                    <p className="text-base sm:text-lg font-medium">Enviado com sucesso!</p>
                    <p className="text-sm opacity-90">Em breve a minha equipa entrará em contato. Obrigada.</p>
                  </motion.div>
              )}
            </AnimatePresence>
          </form>
